...
fn write_uncompressed_multiframe(path: &Path) {
	...
	let mut obj = InMemDicomObject::from_element_iter([
		...
		DataElement::new(tags::PATIENT_ID, VR::LO, PrimitiveValue::from("GOLDEN-UNCOMP")),
	...
	obj.put(DataElement::new(tags::RESCALE_SLOPE, VR::DS, PrimitiveValue::from("1")));
	obj.put(DataElement::new(tags::RESCALE_INTERCEPT, VR::DS, PrimitiveValue::from("0")));
...
fn write_jpeg_fixture(path: &Path, sop_instance_uid: &str, patient_id: &str, frames: Vec<Fragments>) {
...
fn write_sr_without_pixels(path: &Path) {
	let obj = InMemDicomObject::from_element_iter([
		...
		DataElement::new(tags::STUDY_DATE, VR::DA, PrimitiveValue::from("20260608")),
		DataElement::new(tags::SERIES_DESCRIPTION, VR::LO, PrimitiveValue::from("No pixel fixture")),
